...
In this mini-project, you will explore FiveThirtyEight's Halloween candy set. FiveThirtyEight, sometimes rendered as just 538, is an American website that focuses mostly on opinion poll analysis, politics, econimics, and sports blogging. We will **ggplot** some basic stats, correlation analysis and PCA to make sense of the landscape of US candy. 

transciptomics work that we will use these mtohods on throughout the rest of the course
...
candy$chocolate
```
A 1 would represent true and a 0 would represent false.
...
mean(fruit.win)
```
Chocolate candy is higher ranked that fruit candy.
...
Nik L Nip was the least popular
```{r}
...
These make sense to me when in reference to the halloween candy PCA where fruity has a positive correlation
